  ...
  describe('generateToken', () => {
    describe('successful token generation', () => {
      it('should generate a token with valid user claims', () => {
        const claims = createMockClaims('user-123', 'test@example.com', ['user'])
      ...
      it('should delegate to JwtUtil.generateToken', () => {
        const claims = createMockClaims('user-456', 'another@example.com', ['admin'])
      ...
      it('should return the token generated by JwtUtil', () => {
        const claims = createMockClaims('user-789', 'user@example.com', ['user', 'moderator'])
    ...
    describe('handling different user claims', () => {
      it('should handle user with single role', () => {
        const claims = createMockClaims('user-single-role', 'single@example.com', ['user'])
      ...
      it('should handle user with multiple roles', () => {
        const claims = createMockClaims('user-multi-role', 'multi@example.com', [
          'user',
          'admin',
          'superadmin',
        ])
      ...
      it('should handle user with empty roles array', () => {
        const claims = createMockClaims('user-no-roles', 'noroles@example.com', [])
      ...
      it('should handle user with special characters in email', () => {
        const claims = createMockClaims('user-special', 'user+test@sub.domain.example.com', [
          'user',
        ])
    ...
    describe('token format validation', () => {
      ...
      it('should return non-empty string', () => {
        const claims = createMockClaims('user-456', 'nonempty@example.com', ['user'])
      ...
      it('should handle realistic JWT token format', () => {
        const claims = createMockClaims('user-789', 'realistic@example.com', ['admin'])
    ...
    describe('adapter pattern validation', () => {
      it('should act as a proper adapter to JwtUtil', () => {
        const claims = createMockClaims('adapter-test', 'adapter@example.com', ['user'])
      ...
      it('should not modify claims before passing to JwtUtil', () => {
        const claims = createMockClaims('immutable-test', 'immutable@example.com', [
          'user',
          'admin',
        ])
      ...
      it('should forward return value from JwtUtil without modification', () => {
        const claims = createMockClaims('forward-test', 'forward@example.com', ['user'])
    ...
    describe('multiple invocations', () => {
      it('should generate different tokens for different users', () => {
        const claims1 = createMockClaims('user-1', 'user1@example.com', ['user'])
        const claims2 = createMockClaims('user-2', 'user2@example.com', ['admin'])
      ...
      it('should handle consecutive calls independently', () => {
        const claims = createMockClaims('consecutive-user', 'consecutive@example.com', ['user'])
      ...
      it('should maintain stateless behavior across invocations', () => {
        const claims1 = createMockClaims('stateless-1', 'stateless1@example.com', ['user'])
        const claims2 = createMockClaims('stateless-2', 'stateless2@example.com', ['admin'])
    ...
    describe('integration with port interface', () => {
      it('should satisfy TokenGeneratorPort contract', () => {
        const claims = createMockClaims('port-test', 'port@example.com', ['user'])
      ...
      it('should work with dependency injection', () => {
        ...
        const claims = createMockClaims('di-test', 'di@example.com', ['user'])
